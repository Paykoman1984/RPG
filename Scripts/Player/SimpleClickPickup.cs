...
{
    public class SimpleClickPickup : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void Update()
        {
            ...
            // Gentle up/down bobbing animation - NO ROTATION
            float yOffset = Mathf.Sin(time * 2f) * 0.1f; // Moves up/down 0.1 units
        ...
        private void PickupItem()
        {
            ...
            // ADDED: Proximity check - player must be near the item
