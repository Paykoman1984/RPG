...
namespace PoEClone2D.Combat
{
    public class MeleeAttack : MonoBehaviour
    {
        ...
        private System.Collections.IEnumerator AutoCompleteAttack()
        {
            ...
            // Add a small safety buffer (0.2 seconds)
            ...
            if (isAttacking)
            {
                Debug.LogWarning($"⚠️ Attack didn't complete automatically after {maxAttackTime:F2} seconds. Forcing completion.");
                CompleteAttack();
            }
        }
